...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        stmt.executeUpdate("CREATE TABLE IF NOT EXISTS `formstatus` (`StatusID`  int(11) UNSIGNED NOT NULL AUTO_INCREMENT, PRIMARY KEY (`StatusID`) )" +
                "ENGINE=InnoDB DEFAULT CHARACTER SET=latin1 COLLATE=latin1_swedish_ci AUTO_INCREMENT=1;");
